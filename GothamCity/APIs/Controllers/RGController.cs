...
namespace APIs.Controllers
{
    ...
    public class RGsController : ControllerBase
    {
        ...
        public static async Task<string> CreateResourceGroup()
        {
            ...
            client.BaseAddress = new Uri("https://management.azure.com/subscriptions/" + SubscriptionID + "/resourcegroups/" + ResourceGroupName + "?api-version=2019-10-01");
        ...
        [HttpPut]
        public async Task<string> CreateRG()
        {
